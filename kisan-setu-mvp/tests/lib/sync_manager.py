"""
Sync Manager Component — test-only utility, NOT deployed to Lambda.
===================================================================

This module provides a richer offline-first sync implementation used
exclusively by property-based and unit tests:
- tests/test_sync_manager.py
- tests/test_last_write_wins_conflict_resolution_properties.py
- tests/test_sync_completion_notification_properties.py

The deployed Lambda handler is lambda/sync/sync_handler.py, which
implements its own simpler sync logic directly.

Moved from lambda/sync/ to tests/lib/ — Issue #5, March 2026 audit.
"""
